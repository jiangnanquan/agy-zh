...
`~/.local/bin/agy.zh-backup-1.1.27`。汉化后的可执行文件使用 macOS ad-hoc
...
| 组件 | 版本 | 说明 |
|------|------|------|
| `agy` 二进制 | v1.1.27 | SHA-256 锁定适配版本 |
| `agy-hud` 插件 | 内置增强版 | 内置完整源码，支持官方 1.1.27 双配额窗口 (5h/1W) 与极简展示预设 |
